...
def dxaj_hydrodataset_args(basin_ids):
    project_name = os.path.join("Anhui_dPL_TL", "A04_anhui16_608_A04A05A08A09_b0500_fl240_lr005_seed1111_train")
    ...
    model_path = os.path.join(
        "Result/Sec3_ParamTrans/Anhui_dPL/anhui16_608_A04A05A08A09_b0500_fl240_lr005_seed1111/best_model.pth"
    )
    stat_file_path = os.path.join(
        "Result/Sec3_ParamTrans/Anhui_dPL/anhui16_608_A04A05A08A09_b0500_fl240_lr005_seed1111/dapengscaler_stat.json"
    )
    return cmd(
        # 1. 项目和基础配置
        sub=project_name,
