...
# @Last Modified time: 2025-09-05 10:00:02
import os
import pandas as pd
...
csv_path = r"./Data/Select/anhui_50913900_24.csv"
...
def dxaj_hydrodataset_args(basin_ids):
    project_name = os.path.join("Anhui_EnLoss-dPL_TL", "A04_anhui16_608_A04A05A08A09_b0500_fl240_lr005_w1_seed1111_train")
    ...
    model_path = os.path.join(
        "Result/Sec3_ParamTrans/Anhui_EnLoss-dPL/anhui16_608_A04A05A08A09_b0500_fl240_lr005_w1_seed1111/best_model.pth"
    )
    stat_file_path = os.path.join(
        "Result/Sec3_ParamTrans/Anhui_EnLoss-dPL/anhui16_608_A04A05A08A09_b0500_fl240_lr005_w1_seed1111/dapengscaler_stat.json"
    )
    return cmd(
        # 1. 项目和基础配置
        sub=project_name,
