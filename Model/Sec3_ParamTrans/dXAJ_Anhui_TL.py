...
csv_path = r"./Data/Transfer/anhui19_681_A04.csv"
...
def dpl_selfmadehydrodataset_args(basin_ids):
    project_name = os.path.join("Anhui_dPL", "TL_anhui_A04_train")
    ...
    model_path = os.path.join("Result/Anhui_dPL/anhui17_646_A04A05A09_b0500_fl240_lr005_seed1111/best_model.pth")
    stat_file_path = os.path.join("Result/Anhui_dPL/anhui17_646_A04A05A09_b0500_fl240_lr005_seed1111/dapengscaler_stat.json")
