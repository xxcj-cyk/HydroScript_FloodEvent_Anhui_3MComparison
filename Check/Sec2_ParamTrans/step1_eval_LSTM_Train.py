...
configuration_name = "_without_b05_fl72_lr0005_seed1111"
basin_names = [
    "anhui_50406910_20",
    "anhui_50501200_34",
    "anhui_50701100_41",
...
csv_path = [
    "./Data/Transfer/anhui_50406910_20_without.csv",
    "./Data/Transfer/anhui_50501200_34_without.csv",
    "./Data/Transfer/anhui_50701100_41_without.csv",
    "./Data/Transfer/anhui_50913900_24_without.csv",
    "./Data/Transfer/anhui_51004350_18_without.csv",
    "./Data/Transfer/anhui_62549024_78_without.csv",
    "./Data/Transfer/anhui_62700110_27_without.csv",
    "./Data/Transfer/anhui_62700700_38_without.csv",
    "./Data/Transfer/anhui_62802400_17_without.csv",
    "./Data/Transfer/anhui_62802700_61_without.csv",
    "./Data/Transfer/anhui_62803300_87_without.csv",
    "./Data/Transfer/anhui_62906900_38_without.csv",
    "./Data/Transfer/anhui_62907100_25_without.csv",
    "./Data/Transfer/anhui_62907600_15_without.csv",
    "./Data/Transfer/anhui_62907601_14_without.csv",
    "./Data/Transfer/anhui_62909400_62_without.csv",
    "./Data/Transfer/anhui_62911200_43_without.csv",
    "./Data/Transfer/anhui_62916110_20_without.csv",
    "./Data/Transfer/anhui_70112150_10_without.csv",
    "./Data/Transfer/anhui_70114100_33_without.csv",
]
...
def step1_extract_validation_metrics(current_project_name):
    ...
    output_dir = f"./Visualization/Sec2_ParamTrans/Train/{model_name}/{current_project_name}"
...
def step3_merge_training_validation_data(current_project_name):
    ...
    output_csv = f"./Visualization/Sec2_ParamTrans/Train/{model_name}/{current_project_name}/{model_name}_{project_name}_metrics.csv"
    valid_csv = f"./Visualization/Sec2_ParamTrans/Train/{model_name}/{current_project_name}/{model_name}_{current_project_name}_valid_metrics.csv"
    combined_csv = f"./Visualization/Sec2_ParamTrans/Train/{model_name}/{current_project_name}/{model_name}_{current_project_name}_metrics.csv"
...
def step4_standardize_data(current_project_name):
    ...
    combined_csv = f"./Visualization/Sec2_ParamTrans/Train/{model_name}/{current_project_name}/{model_name}_{current_project_name}_metrics.csv"
    final_csv = f"./Visualization/Sec2_ParamTrans/Train/{model_name}/{current_project_name}/{model_name}_{current_project_name}.csv"
...
def step5_merge_final_csvs():
    """合并所有项目的最终csv为一个总表"""
    all_dfs = []
    for project in base_project_name:
        final_csv = f"./Visualization/Sec2_ParamTrans/Train/{model_name}/{project}/{model_name}_{project}.csv"
    ...
    if all_dfs:
        ...
        merged.to_csv(
            f"./Visualization/Sec2_ParamTrans/Train/{model_name}/{model_name}_Merged{configuration_name}.csv",
            index=False,
        )
        print(
            f"所有项目结果已合并到: ./Visualization/Sec2_ParamTrans/Train/{model_name}/{model_name}_All_Merged.csv"
        )
    else:
        print("没有找到可合并的csv文件。")
...
def main():
    ...
    try:
        ...
        for i, current_project in enumerate(base_project_name):
            ...
            print(
                f"结果文件: ./Visualization/Sec2_ParamTrans/Train/{model_name}/{current_project}/{model_name}_{current_project}.csv"
            )
