...
def dxaj_hydrodataset_args(basin_ids, filename, source_basin):
    project_name = os.path.join("Anhui_dPL_TL", f"{filename}_b0100_fl240_lr005_seed1111_tl_both_b0100")
    ...
    # 使用源流域的模型文件进行迁移学习
    trained_weight_path = (
        f"Result/Sec1_ModelPerf/Anhui_dPL/b0100_fl240_lr005_seed1111/{source_basin}_b0100_fl240_lr005_seed1111/best_model.pth"
    )
    stat_file_path = (
        f"Result/Sec1_ModelPerf/Anhui_dPL/b0100_fl240_lr005_seed1111/{source_basin}_b0100_fl240_lr005_seed1111/dapengscaler_stat.json"
    )
    return cmd(
        # 1. 项目和基础配置
        sub=project_name,
...
def run_dpl_exp(csv_paths):
    for csv_path in csv_paths:
        ...
        args_ = dxaj_hydrodataset_args(basin_ids, filename, source_basin)
