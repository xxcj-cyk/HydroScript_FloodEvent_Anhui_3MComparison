...
def lstm_hydrodataset_args(basin_ids):
    project_name = os.path.join("Anhui_LSTM", "LSTM16_21basin_797flood")
    ...
    model_path = os.path.join("results/Anhui_LSTM/TL_LSTM16_nopet_96basin/best_model.pth")
    stat_file_path = os.path.join("results/Anhui_LSTM/TL_LSTM16_nopet_96basin/dapengscaler_stat.json")
